...
<img style="float: right; width: 30%; padding: 5px;" src=" {{ site.url }}/pics/heart.png">**ECG Amplifier** [(report)]({{ site.url }}/reports/ECG.pdf) [(video)]({{ site.url }}/reports/ECG.mp4)
...
<img style="float: right; width: 30%; padding: 5px;" src=" {{ site.url }}/pics/heart.png">
